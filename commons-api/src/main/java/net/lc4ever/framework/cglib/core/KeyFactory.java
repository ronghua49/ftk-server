 ...
 */
abstract public class KeyFactory<I> {
...
//	private static final Type KEY_FACTORY = TypeUtils.parseType("net.lc4ever.framework.cglib.core.KeyFactory");
	
	private static final Type KEY_BASE = TypeUtils.parseType("net.lc4ever.framework.cglib.core.AbstractClassKey");
	
	public static final class KeyKey implements ClassKey {
		
		private String clazz;
		private KeyKey(String clazz) {
			this.clazz = clazz;
		}
		public ClassKey newInstance(String clazz) {
			return new KeyKey(clazz);
		}
		/**
		...
		public boolean equals(Object obj) {
			return obj!=null && obj.getClass().equals(KeyKey.class) && (clazz==null?((KeyKey)obj).clazz==null:clazz.equals(((KeyKey)obj).clazz));
		}
		@Override
	...
	//generated numbers: 
	private final static int PRIMES[] = { 11, 73, 179, 331, 521, 787, 1213, 1823, 2609, 3691, 5189, 7247, 10037, 13931, 19289, 26627, 36683, 50441, 69403, 95401, 131129, 180179, 247501, 340057, 467063, 641371, 880603,
			1209107, 1660097, 2279161, 3129011, 4295723, 5897291, 8095873, 11114263, 15257791, 20946017, 28754629, 39474179, 54189869, 74391461, 102123817, 140194277, 192456917, 264202273, 362693231, 497900099, 683510293,
	...
	public static <I> I create(Class<I> keyInterface) {
		return create(keyInterface, null);
	}

	public static <I> I create(Class<I> keyInterface, Customizer customizer) {
		return create(keyInterface.getClassLoader(), keyInterface, customizer);
	}

	public static <I> I create(ClassLoader loader, Class<I> keyInterface, Customizer customizer) {
		Generator<I> gen = new Generator<I>();
	...
	public static class Generator<I> extends AbstractClassGenerator<I> {

		private static final Source SOURCE = new Source(KeyFactory.class.getName());

		private Class<I> keyInterface;
		...
		public void setInterface(Class<I> keyInterface) {
			this.keyInterface = keyInterface;
		}

		public I create() {
			setNamePrefix(keyInterface.getName());
			KeyKey key = new KeyKey(keyInterface.getName());
		...
		@Override
		protected I firstInstance(Class<I> type) {
			return ReflectUtils.newInstance(type);
		}

		@Override
		protected I nextInstance(I instance) {
			return instance;
		}
...
//			if (!newInstance.getReturnType().equals(Object.class)) { throw new IllegalArgumentException("newInstance method must return Object"); }
			if (!newInstance.getReturnType().isAssignableFrom(ClassKey.class)) { throw new IllegalArgumentException("newInstance method must return a ClassKey"); }
...
//			ce.begin_class(Constants.V1_2, Constants.ACC_PUBLIC, getClassName(), KEY_FACTORY, new Type[] { Type.getType(keyInterface) }, Constants.SOURCE_FILE);
			ce.begin_class(Constants.V1_2, Constants.ACC_PUBLIC, getClassName(), KEY_BASE, new Type[] { Type.getType(keyInterface) }, Constants.SOURCE_FILE);
