...
class FastClassEmitter<T> extends ClassEmitter {
	...
	private static final Type FAST_CLASS = TypeUtils.parseType("net.lc4ever.framework.cglib.reflect.FastClass");
	...
	public FastClassEmitter(ClassVisitor v, String className, Class<T> type) {
		super(v);
	...
	private static void invokeSwitchHelper(final CodeEmitter e, List<? extends Member> members, final int arg, final Type base) {
