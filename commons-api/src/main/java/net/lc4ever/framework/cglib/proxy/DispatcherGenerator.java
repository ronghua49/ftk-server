...
class DispatcherGenerator implements CallbackGenerator {
	...
	private static final Type DISPATCHER = TypeUtils.parseType("net.lc4ever.framework.cglib.proxy.Dispatcher");

	private static final Type PROXY_REF_DISPATCHER = TypeUtils.parseType("net.lc4ever.framework.cglib.proxy.ProxyRefDispatcher");
