 ...
 */
abstract public class BeanMap<T> implements Map<String, Object> {
	...
	public static <T> BeanMap<T> create(Class<T> clazz) {
		Generator<T> gen = new Generator<T>();
		gen.setBeanClass(clazz);
		return gen.create();
	}

	public static class Generator<T> extends AbstractClassGenerator<BeanMap<T>> {
		...
		interface BeanMapKey {
			...
			public ClassKey newInstance(String type, int require);
		}
		...
		public void setBean(T bean) {
			this.bean = bean;
			if (bean != null) beanClass = (Class<? extends T>) bean.getClass();
		}
		...
		public BeanMap<T> create() {
			...
			return super.create(KEY_FACTORY.newInstance(beanClass.getName(), require));
		}
	 ...
	 * @return a new <code>BeanMap</code> instance
	 */
	abstract public BeanMap<T> newInstance(T bean);
	...
	protected Converter<T, Object> converter;

	protected BeanMap() {
	}

	protected BeanMap(T bean) {
		setBean(bean);
	}
	 ...
	 */
	abstract public Object get(T bean, Object key);
	 ...
	 */
	abstract public Object put(T bean, String key, Object value);
	...
	public boolean containsValue(Object value) {
		for (String key: keySet()) {
			Object v = get(key);
			if (value==v || (value!=null&&value.equals(v))) return true;
		}
		return false;
