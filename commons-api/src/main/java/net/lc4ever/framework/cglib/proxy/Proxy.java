...
public class Proxy implements Serializable {
	...
	private static final CallbackFilter BAD_OBJECT_METHOD_FILTER = new CallbackFilter() {
		...
		public int accept(Method method) {
			if (method.getDeclaringClass().getName().equals("java.lang.Object")) {
				...
				if (!(name.equals("hashCode") || name.equals("equals") || name.equals("toString"))) { return 1; }
			}
			return 0;
		}
	};
	...
	public static InvocationHandler getInvocationHandler(Object proxy) {
		if (!(proxy instanceof ProxyImpl)) { throw new IllegalArgumentException("Object is not a proxy"); }
		return ((Proxy) proxy).h;
	}

	@SuppressWarnings("unchecked")
	public static Class<? extends ProxyImpl> getProxyClass(ClassLoader loader, Class<?>[] interfaces) {
