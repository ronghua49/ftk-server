...
public class BeanGenerator<T> extends AbstractClassGenerator<T> {
	...
	interface BeanGeneratorKey {
		public ClassKey newInstance(String superclass, Map<String,Type> props);
	}
...
//	private boolean classOnly;
	...
	public void addProperty(String name, Class<?> type) {
		if (props.containsKey(name)) { throw new IllegalArgumentException("Duplicate property name \"" + name + "\""); }
...
//	}
	...
	private T createHelper() {
		...
		ClassKey key = KEY_FACTORY.newInstance(superName, props);
...
//			return protoclass;
//		} else {
//			return ReflectUtils.newInstance(instance.getClass());
//		}
		return (T) ReflectUtils.newInstance(instance.getClass());
	}
