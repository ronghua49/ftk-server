 ...
 * 
 * TODO: ClassKey and Constructor
 * @deprecated to many bugs, TODO: add toString, equals, hashCode delegate.
 */
@Deprecated
public class ImmutableBean {
	...
	public static class Generator<T> extends AbstractClassGenerator<T> {
		...
		public T create() {
			...
			setNamePrefix(name);
			ClassKey key = KeyFactory.create(ImmutableBeanKey.class).newInstance(target);
