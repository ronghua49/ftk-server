...
class InvocationHandlerGenerator implements CallbackGenerator {
	...
	private static final Type INVOCATION_HANDLER = TypeUtils.parseType("net.lc4ever.framework.cglib.proxy.InvocationHandler");

	private static final Type UNDECLARED_THROWABLE_EXCEPTION = TypeUtils.parseType("net.lc4ever.framework.cglib.proxy.UndeclaredThrowableException");
