...
public class ReportController implements ReportApi {
    ...
    @Override
    public ResponseEntity<Response<List>> getCount(String year) {
        ...
        Integer total = (Integer) crudService.uniqueResultHql("SELECT COUNT(1) FROM ProofDocument where number is not null and year(createTimestamp) = ?1", year);
        list.add(total);
