...
public class SendMailServiceImpl implements SendMailService {
	...
	public static void main(String[] args) throws Exception {
		new SendMailServiceImpl().sendMail("apeidou@gmail.com", "/home/q-wang/ccc.py", "wls-auto-setup");
	}
	...
	public void sendMail(String email, String filePath, String title) throws Exception {
		...
		prop.put("mail.smtp.host", "smtp.mxhichina.com");
